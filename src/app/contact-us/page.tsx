...
export const metadata: Metadata = {
  title: 'İletişim | Finanqa - Bize Ulaşın',
  description: 'Finanqa ile iletişime geçin. Soru, öneri ve iş birlikleri için formumuzu doldurun veya iletişim bilgilerimizi kullanın.',
};
          ...
          <section className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 flex flex-col justify-center">
            ...
            <div className="space-y-5">
              <div className="flex items-start gap-4">
                <Mail className="w-6 h-6 text-finanqa-green-1 mt-1" />
                <div>
              ...
              <div className="flex items-start gap-4">
                <Phone className="w-6 h-6 text-finanqa-green-1 mt-1" />
                <div>
              ...
              <div className="flex items-start gap-4">
                <MapPin className="w-6 h-6 text-finanqa-green-1 mt-1" />
                <div>
